...
<head>
    ...
    <title>Revista online UI1 - Panel de administración</title>
    <!-- Favicon -->
                                ...
                                <select id="author" class="form-select" name="author" aria-label="Default select example">
                                    <?php
                                        foreach ($AuthorsArray as $author) {
                                            echo "<option value=". $author['DNI'] .">" . $author['NOMBRE'] . " " . $author['APELLIDOS'] . "</option>";
                                        }
                                    ?>
                                </select>
                                </div>
                                    ...
                                    <select id="magazines" class="form-select" name="IDmagazine" aria-label="Default select example">
                                        <?php
                                            foreach ($MagazinesArray as $magazine) {
                                                echo "<option value=". $magazine['COD_REV'] .">" . $magazine['TITULO'] . "</option>";
                                            }
                                        ?>
                                    </select>
                                </div>
