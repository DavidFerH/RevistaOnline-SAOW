...
<body>
    ...
    <form class="row needs-validation justify-content-center mt-4" action="PHP Processors/processModifyAuthor.php" method="post">
        <div class="col-4">
    ...
    <form action="PHP Processors/deleteAuthor.php" method="post">
